...
export const metadata: Metadata = {
    title: {
        default: 'PhimHay - Xem phim miễn phí, cập nhật phim mới hàng ngày, chất lượng cao',
        template: '%s | PhimHay',
    },
    description:
        'PhimHay - Trang web xem phim miễn phí với đa dạng thể loại và quốc gia. Cập nhật phim mới hàng ngày, chất lượng cao, phụ đề đầy đủ.',
    keywords: [
        'xem phim',
        'phim miễn phí',
        'phim online',
    ...
    authors: [{ name: '2KaiMe Team' }],
    creator: '2KaiMe',
    publisher: '2KaiMe',
    applicationName: 'PhimHay',
    formatDetection: {
        email: false,
        address: false,
        telephone: false,
    ...
    openGraph: {
        title: 'PhimHay - Xem phim miễn phí, cập nhật phim mới hàng ngày, chất lượng cao',
        description:
            'PhimHay - Trang web xem phim miễn phí với đa dạng thể loại và quốc gia. Cập nhật phim mới hàng ngày, chất lượng cao, phụ đề đầy đủ.',
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'PhimHay - Xem phim miễn phí, cập nhật phim mới hàng ngày, chất lượng cao',
            },
            {
